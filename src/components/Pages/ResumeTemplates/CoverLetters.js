...
const CoverLetters = () => {
  return (
    <>
    <div className=' flex sm:flex-row lg:space-x-[51rem] sm:mt-0 sm:ml-0 -ml-40 z-10 sm:h-52 h-20 '>
    <div className='sm:mt-20 sm:ml-0 sm:w-10/12 w-72 flex flex-col sm:justify-normal sm:p-0 justify-start sm:text-start text-gray-900 sm:font-poppins'>
      ...
      <img src={CoverLettImage} alt='' className='hidden absolute md:flex  w-auto h-96 -mt-40'/>
    </div>
    </>
  )
}
