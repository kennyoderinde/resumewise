...
const Cvs = () => {
  return (
    <>
      <div className=' flex flex-row sm:space-x-[51rem] sm:mt-0 -mt-0 sm:ml-0 -ml-40 z-10 sm:h-52 h-20'>
      ...
      <img src={CVImg} alt='' className='hidden sm:flex flex-col absolute w-11/12 h-96 -mt-48'/>
      </div>
    </>
  )
}
