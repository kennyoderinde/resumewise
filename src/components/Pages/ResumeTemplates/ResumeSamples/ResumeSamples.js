        ...
        resumeSamplesData_.map(item => (
          ...
          >
            ...
            <a href="#_" class="relative w-8 px-1 py-3 font-bold text-white rounded-full group sm:top-24 top-24 sm:left-52 left-64 ">            
              ...
              <span class="absolute inset-0 w-full h-full transition duration-300 transform translate-x-1 translate-y-1 bg-[#090c13] ease opacity-90 group-hover:translate-x-0 group-hover:translate-y-0 mix-blend-screen"></span>
            ...
            <div className='  sm:w-64 sm:h-[22rem] w-80 h-[27rem] flex ' style={{ boxShadow: '0 0 50px rgba(0, 0, 0, 0.04)' }}>{item.img}</div>
